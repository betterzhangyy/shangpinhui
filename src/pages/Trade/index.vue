  ...
  <div class="trade-container">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{addressDefault.fullAddress}}</span>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        msg: '',  //收集买家留言信息
        orderId: ''  //提交订单，服务器返回的订单号，存起来，给支付组件传递
       }
    },
    mounted() {
      //获取用户地址信息
    ...
    methods: {
      ...
      async submitOrder() {
        ...
        let {consignee, phoneNum, fullAddress} = this.addressDefault
        let data = {
          consignee,  //收件人姓名
          ...
          orderDetailList: this.orderInfo.detailArrayList   //多个商品的数组 
        }
        let result = await this.$API.reqSubmitOrder(tradeNo, data)
        //订单提交成功
        if(result.code == 200) {
          this.orderId = result.data  //订单号8368
          //路由跳转Pay组件 + 传递参数
